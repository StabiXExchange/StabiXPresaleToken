...
const StabiXPresaleToken = artifacts.require('./StabiXPresaleToken.sol');
const Crowdsale = artifacts.require('./StabiXPresale.sol');
...
contract('Crowdsale', (accounts) => {
  ...
  beforeEach(async function() {
      ...
      this.token = StabiXPresaleToken.at(await this.crowdsale.token());
  ...
  describe('Pause', function() {
    ...
    describe('Crowdsale', async function() {
        ...
        it('should own the stabix presale token', async function() {
...
contract('StabiXPresaleToken', (accounts) => {
  ...
  let units;
   ...
   describe('Token', function() {
      ...
      beforeEach(async function() {
        ...
        token = await StabiXPresaleToken.new();
